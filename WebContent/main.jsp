					...
					<!-- Two -->
							<section id="two">
								<div class="inner">
									...
									<ul class="actions">
									<%if(info != null){ %>
									<li><%=info.getEmail()%>님의 메세지함</li>
									<%}else{ %>
									<li>로그인을 하세요.</li>
									<%}%>
										
										<li><a href="DeleteServiceCon.do" class="button next scrolly">전체삭제하기</a></li>
									</ul>
									<table>
										<tr>
											<td>번호</td>
										...
										<tr>
											...
											<td><a href="DeleteOneCon.do?num=<%=list.get(i).getNum() %>">삭제</a></td>
										</tr>
										<%} %>
									</table>
								</div>
						...
						<div class="inner">
							<section>
								...
								<div class="field half first">
										...
										<input type="text" name="send" id="name" placeholder="보내는 사람 이름" />
									</div>
									<div class="field half">
										<label for="email">Email</label>
										<input type="text" name="receive" id="email" placeholder="보낼 사람 이메일"/>
									</div>
